...
const Popup = ({ text, setOpenWin }: { text: string | ReactNode; setOpenWin: (value: boolean) => void }) => {
  ...
  return (
    <div
      ...
      ref={ref}>
      <svg width="25" height="9" viewBox="0 0 175 91" xmlns="http://www.w3.org/2000/svg" className="fill-slate-200">
        <path d="M87.5 0.953583L174.873 90.2732H0.126999L87.5 0.953583Z" />
      </svg>

      <div className="p-4 rounded bg-slate-200 text-black">{text}</div>
    </div>
  );
};
